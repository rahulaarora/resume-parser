...
const Dashboard = (props) => {
  ...
  const skills = props.skills.split(',').map((skill) => skill.trim())
  ...
  return (
    <>
      ...
      <nav className='sb-topnav navbar navbar-expand navbar-dark bg-dark'>
        ...
        {/* <!-- Sidebar Toggle--> */}
        <button
          className='btn btn-link btn-sm order-1 order-lg-0 me-0 me-md-4 me-lg-0 flex-grow-1 flex-md-grow-0'
          id='sidebarToggle'
          href='#!'
        >
        ...
        <div className='pe-2 pe-md-3'>
          <a
            href='#'
            className='signOut text-decoration-none'
            onClick={() => {
              signOut()
            }}
          >
        ...
        <div id='layoutSidenav_nav'>
          ...
          >
            ...
            <div className='sb-sidenav-footer'>
              ...
              <span title={props.email}>{props.name}</span>
            </div>
          </nav>
        </div>
                ...
                <div className='card mb-4'>
                  ...
                  <div className='card-body row justify-content-center align-items-center px-4'>
                    {requiredSkills.map((skill, key) => {
                      return (
                        <div
                          className='card me-3 min-w-20 mb-3'
                          style={{ width: '18rem' }}
                          key={key}
                        >
                          <div className='card-body'>
                            ...
                            <p className='card-text'>
                              ...
                              elit. Numquam debitis, unde tenetur dolor placeat
                              deleniti{' '}
                            </p>
