...
class ResumeParser(object):
    ...
    def __get_basic_details(self):
        ...
        self.__details['entity_sections'] = cust_ent
        ...
        # experience = utils.extract_experience(self.__text_raw)   
        # self.__details['exp'] = experience
        ...
        try:
            ...
            self.__details['experience'] = cust_ent['Years of Experience']
            try:
                exp = round(
